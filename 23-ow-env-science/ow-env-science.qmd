...
table(dt_19$alert_level_combined)
...
max_score <- max(dt_19$trust_science_our_society_places_too_much_emphasis_reversed, na.rm = TRUE)
max_score
...
out_tab_contrast_t2_env_climate_chg_cause_z<-
  lmtp_evalue_tab(out_tab_contrast_t2_env_climate_chg_cause_z,
                  scale = c("RD"))
...
out_tab_contrast_t2_env_climate_chg_concern_z<-
  lmtp_evalue_tab(out_tab_contrast_t2_env_climate_chg_concern_z,
                  scale = c("RD"))
...
# make group table
group_tab_envir<- group_tab(tab_envir  , type = "additive")
...
# check N
N
sub_title = "Trust in science (place in society): shift everyone below average to average, do not shift others, N = 32737"
