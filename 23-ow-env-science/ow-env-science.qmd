...
df <- dat |>
  ...
  dplyr::mutate(h_20 = mean(k_19, na.rm = TRUE)) |>  # Hack
...
table( is.na( df$covid19_timeline) )
colnames(df)
...
#  select variables
  ...
  dplyr::select(
   ...
   #  There is no one I can turn to for guidance in times of stress.
    ...
    "community_money",
   # environ vars
   "science_trust01", #I have a high degree of confidence in the scientific community.
   "science_trust02r",# Our society places too much emphasis on science.(n) (SD)
   "science_trust",# #"I have a high degree of confidence in the scientific community./  Our society places too much emphasis on science.(n) (SD)
   "env_climate_chg_real",# "Climate change is real"
   "env_climate_chg_cause",# "Climate change is caused by humans"
   "env_climate_chg_concern", #"I am deeply concerned about climate change."
   "env_sat_nz_environment",# "The quality of New Zealand’s natural environment."
  # "env_motorway_spend",# "Increased government spending on new motorways"
 #  "env_pub_trans_subs",# "Government subsidy of public transport"
 #  "env_sat_waterways", #"the quality and health of the waterways in your local region"
   "env_eff01_action_belief", # "By taking personal action I believe\nI can make a positive difference to environmental problems."
   "env_eff02_action_feeling" # "I feel I can make a difference to\nthe state of the environment."
  ...
  dplyr::mutate(k_18 =  ifelse(wave == 2018 &
                                 !is.na(religion_believe_god), 1, 0)) |>   # creating an indicator for the first wave. Inclusion criteria
...
wide_df <- margot_wide(df,  baseline_vars = baseline_vars,exposure_var = exposure_var,outcome_vars = outcome_vars )
