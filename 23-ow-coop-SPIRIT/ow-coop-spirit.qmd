...
title = "ATE: +1 year causal effect from gain of belief in Spirit/Life Force on virtues"
subtitle_warmth_rd = "Virtue: continuous"
...
ggsave(
  ...
  height = 6,
  units = "in",
  filename = "group_plot_virtue-rd.png",
  device = 'png',
  limitsize = FALSE,
  dpi = 600
)
