...
n_unique(df_clean_donate$id)#29770
...
sl_lib <- c("SL.mean", 
           "SL.glmnet", 
           "SL.ranger", # faster implementation of random forset
           "SL.earth") #
...
format_tab_tmle <- function(tmtp_output, scale = c("RD", "RR"), new_name = "character_string") {
  ...
  tab_tmle <- cbind.data.frame(
    tmtp_output$theta,
    tmtp_output$std.error,
    tmtp_output$conf.low,
    tmtp_output$conf.high
  )
...
church_four_hours<- format_tab_tmle(m_t2_hours_charity, scale = "RD", new_name = "church_four")
...
lmtp_contrast(m_t2_charity_donate,ref = m_t2_charity_donate_null, type = "additive")
