...
plot_charity_church <- margot_plot(
  ...
  type = "RD",
  title = "Church effect on charity",
  subtitle = "+ 4 times per month",
  xlab = "",
  ylab = "",
  estimate_scale = 1,
  base_size = 8,
...
plot_community_church <- margot_plot(
  ...
  type = "RR",
  title = "Church effect on help received",
  subtitle = "+ 4 times per month",
  xlab = "",
  ylab = "",
  estimate_scale = 1,
...
plot_prejudice_church <- margot_plot(
  ...
  type = "RD",
  title = "Church effect on prejudice/acceptance",
  subtitle = "+ 4 times per month",
  xlab = "",
  ylab = "",
  estimate_scale = 1,
...
# contrast_hours_full_time
# 
# tab_hours_only_charity_time<- margot_tab_lmtp(contrast_hours_full_time, scale = "RD", new_name = "Volunteering LMTP: hours socialising + 1pw")
...
#                                                  scale = "RD", 
#                                                  new_name = "Donations LMTP: hours socialising + 1pw")
...
tab_hours_only_charity_time_z <- margot_tab_lmtp(contrast_hours_full_time_z, scale = "RD", new_name = "Volunteering LMTP: hours socialising + 1pw")
...
```{r}
#| label: fig-results-hours-only-charity
...
tab_hours_only_time_community  <- margot_tab_lmtp(hours_only_contrast_time_commmunity_full, scale = "RR", new_name = "Community time LMTP: hours socialising + 1pw")
...
tab_hours_only_time_friends  <- margot_tab_lmtp(contrast_hours_only_friends_full, scale = "RR", 
                                        new_name = "Friends LMTP: hours socialising + 1pw")
...
tab_contrast_hours_only_time_family_full  <- margot_tab_lmtp(contrast_hours_only_time_family_full, scale = "RR", new_name = "Family time LMTP: hours socialising + 1pw")
...
tab_contrast_church_asians_time  <- margot_tab_lmtp(contrast_church_asians_time, scale = "RD", 
                                        new_name = "Warm Asians LMTP: hours socialising + 1pw")
...
tab_contrast_church_chinese_time <- margot_tab_lmtp(contrast_church_chinese_time, scale = "RD", 
                                        new_name = "Warm Chinese LMTP: hours socialising + 1pw")
...
tab_contrast_church_immigrants_time <- margot_tab_lmtp(contrast_church_immigrants_time, scale = "RD", 
                                        new_name = "Warm Immigrants LMTP: hours socialising + 1pw")
...
tab_contrast_church_indians_time <- margot_tab_lmtp(contrast_church_indians_time, scale = "RD", 
                                        new_name = "Warm Indians LMTP: hours socialising + 1pw")
...
tab_contrast_church_elderly_time<- margot_tab_lmtp(contrast_church_elderly_time, scale = "RD", 
                                        new_name = "Warm Elderly LMTP: hours socialising + 1pw")
...
tab_contrast_church_maori_time <- margot_tab_lmtp(contrast_church_maori_time, scale = "RD", 
                                        new_name = "Warm Maori LMTP: hours socialising + 1pw")
...
tab_contrast_church_muslims_time <- margot_tab_lmtp(contrast_church_muslims_time, scale = "RD", 
                                        new_name = "Warm Muslims LMTP: hours socialising + 1pw")
...
tab_contrast_church_euro_time <- margot_tab_lmtp(contrast_church_euro_time, scale = "RD", 
                                        new_name = "Warm NZEuro LMTP: hours socialising + 1pw")
...
tab_contrast_church_overweight_time<- margot_tab_lmtp(contrast_church_overweight_time, scale = "RD", 
                                        new_name = "Warm Overweight LMTP: hours socialising + 1pw")
...
tab_contrast_church_pacific_time<- margot_tab_lmtp(contrast_church_pacific_time, scale = "RD", 
                                        new_name = "Warm Pacific LMTP: hours socialising + 1pw")
...
tab_contrast_church_refugees_time <- margot_tab_lmtp(contrast_church_refugees_time, scale = "RD", 
                                        new_name = "Warm Refugees LMTP: hours socialising + 1pw")
...
tab_contrast_contrast_hours_perceive_religious_discrim_z  <- margot_tab_lmtp(contrast_hours_perceive_religious_discrim_z, scale = "RD", 
                                        new_name = "Perceived Religious Discrimination LMTP: hours socialising + 1pw")
...
omni_plot_help_received <- plot_community_time/ plot_community_church
