...
plot_charity_church <- margot_plot(
  ...
  type = "RD",
  title = "Church Effects on support received",
  subtitle = "LMTP + 4",
  xlab = "",
  ylab = "",
  estimate_scale = 1,
...
plot_community_church <- margot_plot(
  ...
  type = "RR",
  title = "Church Effects on Charity",
  subtitle = "LMTP + 4",
  xlab = "",
  ylab = "",
  estimate_scale = 1,
...
plot_prejudice_church <- margot_plot(
  ...
  type = "RD",
  title = "Church Effects on prejudice/acceptance",
  subtitle = "LMTP + 4",
  xlab = "",
  ylab = "",
  estimate_scale = 1,
...
```{r}
#| label: hours onlysummary all models
#| echo: false
#| include: false
#| eval: false
# volunteering
...
```
#| label: fig-results-time-only-charity
#| fig-cap: "Causal effects of community time on charity"
#| eval: true
#| include: true
#| echo: false
#| fig-height: 6
...
```
#| label: fig-results-time-only-help-received
#| fig-cap: "Causal effects of community time on support received"
#| eval: true
#| include: true
#| echo: false
#| fig-height: 6
...
```
#| label: fig-results-time-only-prejudice
#| fig-cap: "Causal effects of community time on prejudice/acceptance"
#| eval: true
#| include: true
#| echo: false
#| fig-height: 6
