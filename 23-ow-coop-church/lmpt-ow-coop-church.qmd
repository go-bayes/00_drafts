...
```{r}
#| label: church summary all models
#| echo: false
#| include: false
#| eval: false
# volunteering
...
test <- lmtp_evalue_tab(church_hours_charity,  delta = 1, sd = 4, scale = c("RD"))
test
str(test)

test2<- rbind(test, test)
group_tab_test <- group_tab(test2, type = "RD")
margot_plot(group_tab_test, type = "RD", title = "test", subtitle = "test", xlab = "test", ylab="test")



# test
sd( df_clean$t2_hours_charity, na.rm = TRUE )
EValue::evalues.OLS(est = .4029,
                    se =  0.0588,
                    sd = 4.101962)
...
# test
sd( df_clean$t2_charity_donate, na.rm = TRUE )
EValue::evalues.OLS(est = 704,
                    se =  50.8,
                    sd = 4953.71)

# tables
#sd(df_wide_censored_donate$t2_charity_donate, na.rm=TRUE) * .0175
church_donate_charity <- margot_tab_lmtp(contrast_donate_full, scale = "RD", new_name = "Donations: LMTP + 4")
church_hours_charity


# table
tab_charity_rd <- rbind(church_hours_charity, church_donate_charity)
tab_charity_rd


###
EValue::evalues.MD(est = 0.0485, se = 0.0238, true = 0)
EValue::evalues.OLS(est = 703.6558, se = 50.7846 , sd = 4953.71, true = 0)
...
tab_rr <- rbind( church_time_community, church_time_friends, church_time_family ) 
tab_rr

# evalues for RR
EValue::evalues.RR(1.315, lo =1.1895, hi =1.4544)
EValue::evalues.RR(1.1225, lo = 1.0548, hi =1.1945)
EValue::evalues.RR(1.0557, lo = 1.0102, hi =1.1031)
...
contrast_church_asians <- lmtp_contrast(m_church_t2_warm_asians_z,ref = null_m_church_t2_warm_asians_z, 
                                        type = "additive")
contrast_church_asians

tab_contrast_church_asians  <- margot_tab_lmtp(contrast_church_asians, scale = "RD", 
                                        new_name = "Warm Asians LMTP: monthly church + 4")

tab_contrast_church_asians
EValue::evalues.OLS(est = 0.0972,
                    se =  0.0171,
                    sd = 1)
...
# chinese
m_church_t2_warm_chinese_z  <- here_read("m_church_t2_warm_chinese_z")
null_m_church_t2_warm_chinese_z <- here_read("null_m_church_t2_warm_chinese_z")
...
tab_contrast_church_chinese <- margot_tab_lmtp(contrast_church_chinese, scale = "RD", 
...
m_c_t2_warm_indians_z_null  <- here_read("m_c_t2_warm_indians_z_null")
...
tab_contrast_church_indians <- margot_tab_lmtp(contrast_church_indians, scale = "RD", 
...
tab_contrast_church_maori <- margot_tab_lmtp(contrast_church_maori, scale = "RD", 
                                        new_name = "Warm Maori LMTP: monthly church + 4")
 
tab_contrast_church_maori
 
# mental illness
 m_c_t2_warm_mental_illness_z  <- here_read("m_c_t2_warm_mental_illness_z")
 null_m_c_t2_warm_mental_illness_z  <- here_read("null_m_c_t2_warm_mental_illness_z")

 
 contrast_church_mental_illness <- lmtp_contrast(m_c_t2_warm_mental_illness_z,
                                         ref = null_m_c_t2_warm_mental_illness_z,
                                         type = "additive")


 tab_contrast_church_mental_illness<- margot_tab_lmtp(contrast_church_mental_illness, scale = "RD", 
                                        new_name = "Warm Mental Illness: LMTP + 4")
 ...
 null_m_c_t2_warm_muslims_z <- here_read("null_m_c_t2_warm_muslims_z")
...
tab_contrast_church_muslims <- margot_tab_lmtp(contrast_church_muslims, scale = "RD", 
 ...
 null_m_c_t2_warm_nz_euro_z  <- here_read("null_m_c_t2_warm_nz_euro_z")
...
tab_contrast_church_euro <- margot_tab_lmtp(contrast_church_euro, scale = "RD", 
                                        new_name = "Warm NZEuro LMTP: monthly church + 4")

 
 # overweight
 m_c_t2_warm_overweight_z <- here_read("m_c_t2_warm_overweight_z")
 null_m_c_t2_warm_overweight_z <- here_read("null_m_c_t2_warm_overweight_z")
 
 
 contrast_church_overweight <- lmtp_contrast(m_c_t2_warm_overweight_z,
                                         ref = null_m_c_t2_warm_overweight_z,
                                         type = "additive")
contrast_church_overweight

tab_contrast_church_overweight <- margot_tab_lmtp(contrast_church_overweight, scale = "RD", 
...
tab_contrast_church_overweight
 ...
 null_m_c_t2_warm_pacific_z <- here_read("null_m_c_t2_warm_pacific_z")
...
tab_contrast_church_pacific <- margot_tab_lmtp(contrast_church_pacific, scale = "RD", 
 ...
 null_m_c_t2_warm_refugees_z <- here_read("null_m_c_t2_warm_refugees_z")
...
tab_contrast_church_refugees <- margot_tab_lmtp(contrast_church_refugees, scale = "RD", 
...
hours_only_religion_perceive_religious_discrim_z <- lmtp_tmle(
  ...
  trt = A_2,
  baseline = names_base,
  outcome = "religion_perceive_religious_discrim_z",
  cens = C,
  shift = f,
  mtp = TRUE,
  folds = 5,
...
```{r}
#| label: hours only  summary all models
#| echo: false
#| include: false
#| eval: false
# volunteering
...
tab_hours_only_charity_time<- margot_tab_lmtp(contrast_hours_full_time, scale = "RD", new_name = "Volunteering LMTP: hours only + 4")
...
contrast_hours_only_donate_full_time <- lmtp_contrast(m_charity_donate_time,ref = m_charity_donate_null_time, type = "additive")
contrast_hours_only_donate_full_time


tab_hours_only_donate_charity <- margot_tab_lmtp(contrast_hours_only_donate_full_time, 
                                                 scale = "RD", 
                                                 new_name = "Donations LMTP: hours only + 4")
tab_hours_only_donate_charity


# table
tab_hours_only_charity_rd <- rbind(tab_hours_only_charity_time,tab_hours_only_donate_charity)
tab_hours_only_charity_rd
...
tab_hours_only_time_community  <- margot_tab_lmtp(hours_only_contrast_time_commmunity_full, scale = "RR", new_name = "Community time LMTP: hours only + 4")
...
tab_hours_only_time_friends  <- margot_tab_lmtp(contrast_hours_only_friends_full, scale = "RR", 
                                        new_name = "Friends LMTP: hours only + 4")
...
tab_contrast_hours_only_time_family_full  <- margot_tab_lmtp(contrast_hours_only_time_family_full, scale = "RR", new_name = "Family time LMTP: hours only + 4")

tab_contrast_hours_only_time_family_full
tab_hours_only_time_community

tab_hours_only_rr <- rbind( tab_hours_only_time_community, tab_hours_only_time_friends, tab_contrast_hours_only_time_family_full ) 
tab_hours_only_rr
...
tab_contrast_church_asians_time  <- margot_tab_lmtp(contrast_church_asians_time, scale = "RD", 
                                        new_name = "Warm Asians LMTP: hours only + 4")
...
tab_contrast_church_chinese_time <- margot_tab_lmtp(contrast_church_chinese_time, scale = "RD", 
                                        new_name = "Warm Chinese LMTP: hours only + 4")
...
tab_contrast_church_immigrants_time <- margot_tab_lmtp(contrast_church_immigrants_time, scale = "RD", 
                                        new_name = "Warm Immigrants LMTP: hours only + 4")
...
tab_contrast_church_indians_time <- margot_tab_lmtp(contrast_church_indians_time, scale = "RD", 
                                        new_name = "Warm Indians LMTP: hours only + 4")
...
tab_contrast_church_elderly_time<- margot_tab_lmtp(contrast_church_elderly_time, scale = "RD", 
                                        new_name = "Warm Elderly LMTP: hours only + 4")
...
tab_contrast_church_maori_time <- margot_tab_lmtp(contrast_church_maori_time, scale = "RD", 
                                        new_name = "Warm Maori LMTP: hours only + 4")
...
tab_contrast_church_mental_illness_time<- margot_tab_lmtp(contrast_church_mental_illness_time, scale = "RD", new_name = "Warm Mental Illness: LMTP + 4")
...
tab_contrast_church_muslims_time <- margot_tab_lmtp(contrast_church_muslims_time, scale = "RD", 
                                        new_name = "Warm Muslims LMTP: hours only + 4")
...
tab_contrast_church_euro_time <- margot_tab_lmtp(contrast_church_euro_time, scale = "RD", 
                                        new_name = "Warm NZEuro LMTP: hours only + 4")
...
tab_contrast_church_overweight_time<- margot_tab_lmtp(contrast_church_overweight_time, scale = "RD", 
                                        new_name = "Warm Overweight LMTP: hours only + 4")
...
tab_contrast_church_pacific_time<- margot_tab_lmtp(contrast_church_pacific_time, scale = "RD", 
                                        new_name = "Warm Pacific LMTP: hours only + 4")
...
tab_contrast_church_refugees_time <- margot_tab_lmtp(contrast_church_refugees_time, scale = "RD", 
                                        new_name = "Warm Refugees LMTP: hours only + 4")
...
tab_contrast_contrast_hours_perceive_religious_discrim_z  <- margot_tab_lmtp(contrast_hours_perceive_religious_discrim_z, scale = "RD", 
                                        new_name = "Perceived Religious Discrimination LMTP: hours only + 4")
...
# same
EValue::evalues.MD(est = 0.0485, se = 0.0238, true = 0)
EValue::evalues.OLS(est = 0.0485, se = 0.0238, sd = 1, true = 0)




# table
tab_warm_hours_only<- rbind(
  tab_contrast_church_pacific_time,
  tab_contrast_church_refugees_time,
  tab_contrast_church_asians_time,
  tab_contrast_church_chinese_time,
