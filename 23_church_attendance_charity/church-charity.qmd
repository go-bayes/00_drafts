...
mice_donate_mids <- mice_donate_c %>%
  ...
  mutate(t0_eth_cat = as.factor(t0_eth_cat),
    ...
    #    t0_volunteers = as.numeric(ifelse(t0_hours_charity > 1,1,0)),
...
table(mice_donate_long$t2_hours_charity_ord)
table(mice_donate_long$t2_volunteers)


table(mice_donate_long$t2_charity_donate_log)
table(mice_donate_long$t2_charity_donate_log_z)
table(mice_donate_long$t2_charity_donate_ord)
...
# check
table( mice_support_long$t2_family_money_binary)
table( mice_support_long$t2_family_time_binary)
table( mice_support_long$t2_family_time_ord)

table( mice_support_long$t2_friends_money_binary)
table( mice_support_long$t2_friends_time_binary)


table( mice_support_long$t2_community_money_binary)
table( mice_support_long$t2_community_time_binary)

# troubleshoot
skim(mice_support_long)

# this outcome not rare
table(mice_support_long$t2_family_time_binary)
...
sd(mice_donate_long$t2_hours_charity_log, na.rm=TRUE)
...
## not meaningful
# mod_donate_volunteer_pois_rr  <- double_robust(
#   df = dt_donate, 
#   Y = "t2_hours_charity_ord",
#   X = X,
#   baseline_vars = baseline_vars_donate,
...
#   splines = FALSE,
#   vcov = "HC",
#   new_name = "Volunteers (poisson rr)"
# )
# mod_donate_volunteer_pois_rd
# saveRDS(mod_donate_volunteer_pois_rd, here::here(push_mods, "mod_donate_volunteer_pois_rd"))
...
# not meaningful for evalues
# mod_donate_charity_dollars_pois_rd  <- double_robust(
#   df = dt_donate, 
#   Y = "t2_charity_donate_ord",
#   X = X,
#   baseline_vars = baseline_vars_donate,
#   treat_1 = treat_1,
#   treat_0 = treat_0,
...
#   splines = FALSE,
#   vcov = "HC",
#   new_name = "Annual charity (poisson)"
# )
# mod_donate_charity_dollars_pois_rd
# saveRDS(mod_donate_charity_dollars_pois_rd, here::here(push_mods, "mod_donate_charity_dollars_pois_rd"))
...
group_plot_ate_donate_rd <- group_plot_ate(
  group_tab_donate_rd,
  type = "RD",
...
margot_plot(group_tab_donate_rr)

group_plot_ate_donate_rr <- margot_plot(
  group_tab_donate_rr,
  type = "RR",
  title = "ATE: causal contrast:zero to weekly church attendance", 
  subtitle = "Weekly volunteering rate ratio",
  xlab = "(sd units)"
)
...
# not valid for evalues
#sd_hours_charity_ord <- sd(mice_donate_long$t2_hours_charity_ord, na.rm = TRUE)
# 
# mod_donate_hours_charity_pois_rd  <- double_robust(
#   df = dt_donate, 
#   Y = "t2_hours_charity_ord",
#   X = X,
#   baseline_vars = baseline_vars_donate,
...
#   splines = FALSE,
#   vcov = "HC",
#   sd = sd_hours_charity_ord,
#   new_name = "Hours Volunteer (poisson RD)"
# )
# mod_donate_hours_charity_pois_rd
# 
# 
# saveRDS(mod_donate_hours_charity_pois_rd, here::here(push_mods, "mod_donate_hours_charity_pois_rd"))
# 

# 
# # better model 
# mod_hours_charity_pois_rr  <- double_robust(
#   df = dt_donate,  # note change
#   Y = "t2_hours_charity_ord",
#   X = X,
#   baseline_vars = baseline_vars_donate,
...
#   splines = FALSE, 
#   vcov = "HC",
#   new_name = "Hours Volunteer (poisson RR)"
# )
# mod_hours_charity_pois_rr
# saveRDS(mod_hours_charity_pois_rr, here::here(push_mods, "mod_hours_charity_pois_rr"))

# note used
# mod_donate_charity_donate_pois_rr  <- double_robust(
#   df = dt_donate,  # note change
#   Y = "t2_charity_donate_ord",
#   X = X,
#   baseline_vars = baseline_vars_donate,
...
#   splines = FALSE, 
#   vcov = "HC",
#   new_name = "Charity Donations (log)"
# )
# mod_donate_charity_donate_pois_rr
# 
# saveRDS(mod_donate_charity_donate_pois_rr, here::here(push_mods, "mod_donate_charity_donate_pois_rr"))
...
group_plot_ate_warmth <- group_plot_ate(
  group_tab_warmth,
  type = "RD",
  title = "ATE: causal contrast:zero to weekly church attendance", 
...
mod_support_family_time_gauss_rd  <- double_robust(
  df = dt_support,  # note change
  Y = "t2_family_time_log_z",
  X = X,
  ...
  splines = FALSE, 
  vcov = "HC",
  new_name = "Family time (sd)"
)

mod_support_family_time_gauss_rd
saveRDS(mod_support_family_time_gauss_rd, here::here(push_mods, "mod_support_family_time_gauss_rd"))


mod_support_family_time_gauss_rd <- readRDS( here::here(push_mods, "mod_support_family_time_gauss_rd"))
mod_support_family_time_gauss_rd

# for reporting effect (evalues not valid)
# mod_support_family_time_pois_rr  <- double_robust(
#   df = dt_support,  # note change
#   Y = "t2_family_time_ord",
#   X = X,
#   baseline_vars = baseline_vars_support,  ## always check
#   treat_1 = treat_1,
#   treat_0 = treat_0,
...
#   splines = FALSE, 
#   vcov = "HC",
#   new_name = "Family time (poisson rr)"
# )
# 
# mod_support_family_time_pois_rr
# 
# saveRDS(mod_support_family_time_pois_rr, here::here(push_mods, "mod_support_family_time_pois_rr"))

#mod_support_family_time_pois_rr <- readRDS( here::here(push_mods, "mod_support_family_time_pois_rr"))
#mod_support_family_time_pois_rr
...
## friends (not stble)
# mod_support_friends_time_gauss_rd  <- double_robust(
#   df = dt_support,  # note change
#   Y = "t2_friends_time_log_z",
#   X = X,
#   baseline_vars = baseline_vars_support,  ## always check
#   treat_1 = treat_1,
#   treat_0 = treat_0,
...
#   splines = FALSE, 
#   vcov = "HC",
#   new_name = "Friends time (sd)"
# )
# 
# mod_support_friends_time_gauss_rd
# saveRDS(mod_support_friends_time_gauss_rd, here::here(push_mods, "mod_support_friends_time_gauss_rd"))
# 
# mod_support_friends_time_gauss_rd <- readRDS( here::here(push_mods, "mod_support_friends_time_gauss_rd"))
# mod_support_friends_time_gauss_rd

#  Not meaningful
# # for reporting effect (evalues not valid)
# mod_support_friends_time_pois_rr  <- double_robust(
#   df = dt_support,  # note change
#   Y = "t2_friends_time_ord",
#   X = X,
#   baseline_vars = baseline_vars_support,  ## always check
#   treat_1 = treat_1,
#   treat_0 = treat_0,
...
#   splines = FALSE, 
#   vcov = "HC",
#   new_name = "Friends time (poisson rr)"
# )
# 
# mod_support_friends_time_pois_rr
# saveRDS(mod_support_friends_time_pois_rr, here::here(push_mods, "mod_support_friends_time_pois_rr"))
...
## not stable
# mod_support_community_time_gauss_rd  <- double_robust(
#   df = dt_support,  # note change
#   Y = "t2_community_time_log_z",
#   X = X,
#   baseline_vars = baseline_vars_support,  ## always check
#   treat_1 = treat_1,
#   treat_0 = treat_0,
...
#   splines = FALSE, 
#   vcov = "HC",
#   new_name = "Community time (sd)"
# )
# mod_support_community_time_gauss_rd -- Not stable
# saveRDS(mod_support_community_time_gauss_rd, here::here(push_mods, "mod_support_community_time_gauss_rd"))

#mod_support_community_time_gauss_rd <- readRDS( here::here(push_mods, "mod_support_community_time_gauss_rd"))
#mod_support_community_time_gauss_rd


# for reporting effect (evalues not valid)
# mod_support_community_time_pois_rr  <- double_robust(
#   df = dt_support,  # note change
#   Y = "t2_community_time_ord",
#   X = X,
#   baseline_vars = baseline_vars_support,  ## always check
#   treat_1 = treat_1,
#   treat_0 = treat_0,
...
#   splines = FALSE, 
#   vcov = "HC",
#   new_name = "Community time (poisson rr)"
# )
#mod_support_community_time_pois_rr
#saveRDS(mod_support_community_time_pois_rr, here::here(push_mods, "mod_support_community_time_pois_rr"))


# binary
# not converging so use prop scores only
...
group_plot_ate_support_rd <- group_plot_ate(
  group_tab_support,
  type = "RD",
  title = "ATE: causal contrast:zero to weekly church attendance", 
