...
mice_support_mids <- mice_support_c %>%
  ...
  mutate(t0_eth_cat = as.factor(t0_eth_cat),
        t0_education_level_coarsen = as.factor(t0_education_level_coarsen),
        t0_family_time_log =   log(as.integer(round(pmax(t0_family_time, 0)))+1),# to improve model convergence
        t2_family_time_log =   log(as.integer(round(pmax(t2_family_time, 0)))+1),# to improve model convergence
        t0_friends_time_log =   log(as.integer(round(pmax(t0_friends_time, 0)))+1),# to improve model convergence
        t2_friends_time_log =   log(as.integer(round(pmax(t2_friends_time, 0)))+1),# to improve model convergence
        t0_community_time_log =   log(as.integer(round(pmax(t0_community_time, 0)))+1),# to improve model convergence
        t2_community_time_log =   log(as.integer(round(pmax(t2_community_time, 0)))+1),# to improve model convergence
        t0_family_money_log =   log(as.integer(round(pmax(t0_family_money, 0)))+1),# to improve model convergence
        t2_family_money_log =   log(as.integer(round(pmax(t2_family_money, 0)))+1),# to improve model convergence
        t0_friends_money_log =   log(as.integer(round(pmax(t0_friends_money, 0)))+1),# to improve model convergence
        t2_friends_money_log =   log(as.integer(round(pmax(t2_friends_money, 0)))+1),# to improve model convergence
        t0_community_money_log =   log(as.integer(round(pmax(t0_community_money, 0)))+1),# to improve model convergence
        t2_community_money_log =   log(as.integer(round(pmax(t2_community_money, 0)))+1),# to improve model convergence
        t2_family_time_binary = ifelse(t2_family_time > 0, 1, 0),
        t2_friends_time_binary = ifelse(t2_family_time > 0, 1, 0),
        t2_community_time_binary = ifelse(t2_community_time > 0, 1, 0),
        t2_family_money_binary = ifelse(t2_family_money > 0, 1, 0),
        t2_friends_money_binary = ifelse(t2_family_money > 0, 1, 0),
