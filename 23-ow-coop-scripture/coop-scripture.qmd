...
# sum(dat_pr_rel$religion_scripture>=7, na.rm=TRUE)/nrow(dat_pr_rel)
# 
# 
# # ## prop not religious
...
# ggsave(
#   group_plot_support_rd,
#   path = here::here(here::here("figs", "godin", "group_plot_support_rd_scripture_POP")),
#   width = 8,
#   height = 4.5,
#   units = "in",
#   filename = "group_plot_support_rd_scripture_POP.png",
...
# ggsave(
#   group_plot_ate_support_rr,
#   path = here::here(here::here(push_mods, "group_plot_ate_support_rr-scripture-POP")),
#   width = 8,
#   height = 4.5,
#   units = "in",
...
# ggsave(
#   group_plot_ate_support_rr,
#   path = here::here(here::here("figs","godin", "group_plot_ate_support_rr-scripture-POP")),
#   width = 8,
#   height = 4.5,
#   units = "in",
#   filename = "group_plot_ate_support_rr-scripture-POP.png",
...
str(dat_long_tX$religion_scripture_binary)
...
dat_long_tX1  <- dat %>%
 # filter(id %in% religious_ids) %>%
  ...
  mutate(religion_religious = as.numeric(religion_religious) - 1) |>
  mutate(
    religion_scripture_round = round( ifelse(religion_scripture > 14, 8, religion_church), 0) )|> 
  mutate(
    eth_cat = as.integer(eth_cat),
    urban = as.numeric(urban),
    education_level_coarsen = as.integer(education_level_coarsen)
