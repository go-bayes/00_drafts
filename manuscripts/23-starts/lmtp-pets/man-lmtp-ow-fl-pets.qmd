...
```{r}
#| label: tbl-baseline-table-cats 
#| tbl-cap: "Baseline demographic and response statistics for cat ownership study"
#| eval: true
#| echo: false
#| include: false
...
@tbl-baseline-table-cats presents baseline data for the Study 1: the causal effects of cat ownership on multi-dimensional well-being. The "only_cats" variable indicates the percentage of participants who had or did not have cats at baseline. Baseline variables were included to limit confounding of the the treatment/outcome effect.
...
```{r}
#| label: tbl-baseline-table-dogs 
#| tbl-cap: "Baseline demographic and response statistics for cat ownership study"
#| eval: true
#| echo: false
#| include: true

baseline_tab_dogs_gt
```

@tbl-baseline-table-dogs presents baseline data for the Study w: the causal effects of dog ownership on multi-dimensional well-being. The "only_dogs" variable indicates the percentage of participants who had or did not have cats at baseline. Baseline variables were included to limit confounding of the the treatment/outcome effect.
