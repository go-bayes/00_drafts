...
\caption{\label{tbl-table\_demographic\_vars\_cats}Baseline outcome and
democgraphic statistics for cat ownership study}
...
\caption{\label{tbl-table\_confounding\_control\_vars\_cats}Additional
confounding control variables for cat ownership study}
...
\caption{\label{tbl-table\_health\_vars\_cats}Health outcomes measured
at baseline}
...
\caption{\label{tbl-table\_embody\_vars\_cats}Embodied well-being
...
\caption{\label{tbl-table\_reflective\_vars\_cats}Reflective well-being
outcomes measured at baseline}
...
\caption{\label{tbl-table\_social\_vars\_cats}Social well-being outcomes
...
\caption{\label{tbl-table\_demographic\_vars\_dogs}Exposure and
demographic variables measured at baseline}
...
\caption{\label{tbl-table\_confounding\_control\_vars\_dogs}Additional
confounding control variables measured at baseline}
...
\caption{\label{tbl-table\_health\_vars\_dogs}Health outcomes measured
at baseline}
...
\caption{\label{tbl-table\_embody\_vars\_dogs}Embodied well-being
variables measured at baseline}
...
\caption{\label{tbl-table\_reflective\_vars\_dogs}Reflective well-being
variables measured at baseliney}
