...
(\citeproc{ref-fraser}{Fraser \emph{et al.} n.d.}), rely heavily on
...
\item
  ...
  (\citeproc{ref-polley2023}{Polley \emph{et al.} 2023})). These
...
(\citeproc{ref-williams2021}{Williams and Díaz 2021}). One of the
...
\bibitem[\citeproctext]{ref-fraser}
