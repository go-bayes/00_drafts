...
# Initialise
init_church <- msm::crudeinits.msm(religion_church_1n ~ year_w, id, # Id = identifier
                      data = dt,
                      qmatrix = q)
# 
# model
...
msm_church_n <- here_read("msm_church_n")

pmatrix.msm(msm_church_n, covariates = list(age = 80), ci = "normal")
pmatrix.msm(msm_church_n, ci = "normal")
...
pmatrix.msm(msm_spirit,  ci = "normal")
