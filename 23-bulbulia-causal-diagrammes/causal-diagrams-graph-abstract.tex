...
exposure's effect on the mediator, as indicated by dashed paths. Causal
diagrams not only clarify how different types of confounding bias may
converge (here mediation bias and confounder bias), but also reveal the
limitations of common methods such as structural equation models and
multilevel models for handling time-series data when the fourth
assumption fails -- that is, when there is treatment-confounder
