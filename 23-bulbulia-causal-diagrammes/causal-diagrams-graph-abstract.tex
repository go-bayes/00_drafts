...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, enhanced, breakable, frame hidden, interior hidden, boxrule=0pt, sharp corners]}{\end{tcolorbox}}\fi

\begin{figure}

{\centering \includegraphics[width=1\textwidth,height=\textheight]{causal-diagrams-graph-abstract_files/figure-pdf/fig-dag-mediation-assumptions-1.pdf}
