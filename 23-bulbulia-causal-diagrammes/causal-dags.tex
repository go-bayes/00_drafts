...
(\citeproc{ref-neyman1923}{1923}), was further developed by Rubin,
Robins, Pearl, and their students, and provides a robust basis for
future advancements (\citeproc{ref-hernuxe1n2023}{Hernán and Monge
2023}; \citeproc{ref-pearl1995}{Pearl and Robins 1995};
\citeproc{ref-rubin1976}{Rubin 1976};
\citeproc{ref-robins1986}{\textbf{robins1986?}}).
...
(\citeproc{ref-bulbulia2023}{Bulbulia 2023}); see also:
...
see: (\citeproc{ref-hernuxe1n2022a}{Hernán \emph{et al.} 2022};
\citeproc{ref-hernuxe1n2008}{Hernán and Taubman 2008};
\citeproc{ref-murray2021a}{\textbf{murray2021a?}}).
...
be a source of false confidence.\footnote{The careful reader will note a
  ...
  valid causal inference (\citeproc{ref-hernuxe1n2023}{Hernán and Monge
  2023}).}
...
\emph{et al.} (\citeproc{ref-hoffman2022}{2022}); Vansteelandt and Dukes
(\citeproc{ref-vansteelandt2022}{2022}); Muñoz and Laan
(\citeproc{ref-muuxf1oz2012}{2012}); Díaz \emph{et al.}
(\citeproc{ref-duxedaz2021}{2021}); Williams and Díaz
(\citeproc{ref-williams2021}{2021}); Wager and Athey
(\citeproc{ref-wager2018}{2018}); Cui \emph{et al.}
(\citeproc{ref-cui2020}{2020})).
...
1999a}; \citeproc{ref-pearl2009}{Pearl 2009};
\citeproc{ref-pearl1995}{Pearl and Robins 1995}). Causal diagrams are
...
\citeproc{ref-hernuxe1n2023}{Hernán and Monge 2023};
\citeproc{ref-pearl2009a}{\textbf{pearl2009a?}}). It is not a
...
\citeproc{ref-robins1999}{\textbf{robins1999?}};
\citeproc{ref-robins1986}{\textbf{robins1986?}}). As mentioned
...
(\citeproc{ref-watts2018}{\textbf{watts2018?}}).
...
\item
  ...
  diagram and vice
  versa.(\citeproc{ref-pearl2009a}{\textbf{pearl2009a?}};
  \citeproc{ref-pearl1995a}{\textbf{pearl1995a?}}).\footnote{Although
...
\item
  ...
  simpler, conditional relationships.\footnote{Markov factorisation
    ...
    (\citeproc{ref-lauritzen1990}{\textbf{lauritzen1990?}};
    \citeproc{ref-pearl1988}{\textbf{pearl1988?}}). The Causal Markov
    ...
    that it does not cause (\citeproc{ref-hernuxe1n2023}{Hernán and
    Monge 2023}). In essence, once we account for a variable's immediate
    ...
    (\citeproc{ref-pearl2009a}{\textbf{pearl2009a?}}).}
\end{enumerate}
...
\item
  ...
  (\citeproc{ref-pearl1995}{Pearl and Robins 1995}).\footnote{There is
...
\item
  ...
  \citeproc{ref-wright1923}{Wright 1923};
  \citeproc{ref-wright1920}{\textbf{wright1920?}}). Causal diagrams
  ...
  (\citeproc{ref-hernuxe1n2023}{Hernán and Monge 2023}). These
