...
In this section, we have used causal graphs to clarify sources of confounding arising from selection bias, revealing further scope for the practical applications of causal graphs when planning research.
...
Against invarince testing, we should approach comparative research from the vantage point of correlated measurement error. Amending @fig-dag-dep-u-effect  Selecting on unmeasured correlated error structures in the world we have @fig-dag-dep-u-effect-selection... [TBC]
