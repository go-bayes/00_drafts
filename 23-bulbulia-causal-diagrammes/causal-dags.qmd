...
#| fig-cap: "Measurement bias in comparative cross-cultural research. Selection at baseline induces correlations in the measurement error of the exposure and outcome. Biasing paths are presented in red. Where selection induces error, we might be better of conducting separate country-wide analyses. Cross-cultural researchers should not assume that our interest in generalisation, although scientifically desirable, can be supported from the data we collect. Again, careful case-by-case assessments are needed."
#| out-width: 100%
#| echo: false
#| 
\usetikzlibrary{positioning}
