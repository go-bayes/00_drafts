...
\hypersetup{
  pdftitle={Selection Bias: Key Conceptual Distinctions For Longitudinal Designs},
...
\title{Selection Bias: Key Conceptual Distinctions For Longitudinal
Designs}
...
design, data collection, and data analysis in longitudinal (panel)
studies.
\end{abstract}
...
generalisability of our causal inferences. To understand selection bias,
and now it differs from, and relates to structural confounding bias and
structural measurement bias, it is essential to understand the concepts
of `source' and `target' populations, as well as the concepts of
...
Selection bias occurs when the study group (source population) does not
accurately represent the group of interest (target population).
Understanding and addressing this bias is essential for ensuring the
validity and applicability of research findings beyond the immediate
study context (\citeproc{ref-hernuxe1n2017}{Hernán 2017}). Understanding
this bias is crucial for ensuring our research findings are valid and
applicable beyond our immediate study.
