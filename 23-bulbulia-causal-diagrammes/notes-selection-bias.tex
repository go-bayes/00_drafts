...
\hypersetup{
  pdftitle={Considerations of Selection Bias in the Design of Longitudinal Panel Studies},
  pdfauthor={Joseph A. Bulbulia; Etsuji Suzuki},
...
interested in (target population) (\citeproc{ref-hernuxe1n2017}{Hernán
2017}). Understanding this bias is crucial for ensuring our research
...
\citeproc{ref-hernuxe1n2004}{Hernán \emph{et al.} 2004}).\footnote{Note
  ...
  al.} 2021}).} Here, selection does not induce ``confounding in
expectation'' (\citeproc{ref-suzuki2016}{Suzuki \emph{et al.} 2016};
...
\includegraphics[width=0.6\textwidth,height=\textheight]{notes-selection-bias_files/figure-pdf/fig-1-1.pdf}
...
not generalise as we might hope (\citeproc{ref-suzuki2016}{Suzuki
...
\includegraphics[width=0.6\textwidth,height=\textheight]{notes-selection-bias_files/figure-pdf/fig-2-1.pdf}
...
\citeproc{ref-pearl2022}{Pearl and Bareinboim 2022})).
...
\includegraphics[width=0.8\textwidth,height=\textheight]{notes-selection-bias_files/figure-pdf/fig-3-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{notes-selection-bias_files/figure-pdf/fig-4-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{notes-selection-bias_files/figure-pdf/fig-5-1.pdf}
