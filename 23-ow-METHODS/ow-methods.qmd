...
**Part 1** introduces definitions and notation.

**Part 2** describes the three-wave panel, and its motivations.

**Part 3** develops a the step-by-step guide for conducting causal inference within the three-wave panel design

**Part 4** describes common estimators

**Part 5** discusses more complex designs where there is scope for confounder treatment feedback. 


An Appendix describes custom functions I have written for executing the workflows.
