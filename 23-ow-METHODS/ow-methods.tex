...
denoted as \$ f\_\{\text{causal}\}(Y(a), Y(a'))\$, where \(Y(a)\) and
...
f\_\{\text{observed}\}(Y,A) ) differs from the causal contrast (
f\_\{\text{causal}\}(Y(a), Y(a')) ). This difference may arise due to
