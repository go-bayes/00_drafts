...
dt_find_quartile <- dat_long |> 
  filter(wave == 2019) |> 
  mutate(lifemeaning_quartile_1 = ntile(lifemeaning, 4)) %>%
  mutate(lifemeaning_quartile_1 = as.factor(lifemeaning_quartile_1))
dt_find_quartile$lifemeaning_quartile_1
table(dt_find_quartile$lifemeaning_quartile_1)


dt_test <- create_ordered_variable(dt_find_quartile, "lifemeaning", 5)

table( dt_test$lifemeaning_3tile )
