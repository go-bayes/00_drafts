---
title: "Causal effects of meaning on multi-dimensional well-being"
...
dt_positivity_full <- dat_long_t|>
  ...
  select(wave, id, lifemeaning_coarsen) |> 
...
# checks results
# ebal method
bal.tab(match_energy_health_cont)
love.plot(match_energy_health_cont, binary = "std", thresholds = c(m = .1),
          wrap = 50, position = "bottom", size =2) 

# consider results 
sum_energy_health_cont <- summary(match_energy_health_cont)
sum_energy_health_cont
plot(sum_energy_health_cont)



# For trimmed weights e.g.
# trim if needed (weights > 10 might be a problem)
# match_energy_health_cont_trim  <- WeightIt::trim(match_energy_health_cont, at = .99)
#graph
# bal.tab(match_energy_health_cont_trim)
# sum_cont <- summary(match_energy_health_cont_trim)
# sum_cont
# plot(sum_cont)
# 
...
# set df
# do not need to trim data in this study
dt_health_cont = match_energy_health_cont_trim
...
mod_health_alcohol_frequency_con  <- double_robust(
  ...
  treat_1 = treat_1_cont,
  treat_0 = treat_0_cont,
  estimand = estimand,
  scale = "RD",
  nsims = nsims,
  cores = cores,
