---
title: "Church and Religous Affiliation: Chicken/Egg"
...
push_mods <-
  fs::path_expand(
    "/Users/joseph/v-project\ Dropbox/data/nzvs_mods/00drafts/23-church-cause-rel"
  )
...
prep_religion <- margot_wide(dat_long_t, 
  baseline_vars = baseline_vars, 
  exposure_var = exposure_var,
  outcome_vars = outcome_vars_religion)
...
prep_multiple_religion <- margot_filter(prep_religion, exposure_vars = exposure_vars) 
```
...
# # if trim is needed
match_donate_ebal_trim <- WeightIt::trim(match_donate_ebal, at = .9975)
...
# if trim (if needed)
mice_warmth_ebal_trim <- WeightIt::trim(mice_warmth_ebal, at = .9975)
...
ggsave(
  group_plot_virtue,
  path = here::here(here::here(push_mods, "group_plot_virtue_REL")),
  width = 8,
  height = 4.5,
  units = "in",
  filename = "group_plot_virtue-REL.png",
  device = 'png',
  limitsize = FALSE,
  dpi = 600
)
