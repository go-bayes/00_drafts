...
Using one item from @hoverd2010, we asked participants to indicate their religion identification ("Do you identify with a religion and/or spiritual group?") on a binary response (1 = Yes, 0 = No). We then asked "What religion or spiritual group?" in a open-ended question. These questions are used in the New Zealand Census. Responses were coded as Not Religious, Anglican, Buddist, Catholic, Christian_nfd, Christian_Others, Hindu, Jewish, Muslim, PresbyCongReform, or the others.
